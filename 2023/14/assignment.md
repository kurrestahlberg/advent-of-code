 Day 14 - Advent of Code 2023    window.addEventListener('click', function(e,s,r){if(e.target.nodeName==='CODE'&&e.detail===3){s=window.getSelection();s.removeAllRanges();r=document.createRange();r.selectNodeContents(e.target);s.addRange(r);}});
...
[Hapag-Lloyd AG](https://www.hapag-lloyd.com/en/company/career/working-in-tech/overview.html) - Discover boundless horizons in Hapag-Lloyd's IT division! Sail alongside our team, craft solutions & forge the future of technology.
